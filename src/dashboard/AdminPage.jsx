                        ...
                        eventForm.galleryImages.length > 0 && (
                          <div className="mt-3 flex items-center gap-3">
                            ...
                            <span className="text-[11px] text-slate-600">
                              ...
                              {eventForm.galleryImages.length > 1
                                ? "s"
                                : ""}{" "}
                              selected
                            </span>
              ...
              <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                {events.map((event) => (
                  ...
                  >
                    ...
                    <div className="p-4">
                      <h3 className="mb-2 text-sm font-extrabold text-slate-900 line-clamp-2">
                        {event.name}
                      </h3>
...
function StatCard({ label, value, icon, color }) {
  return (
    <div
      className={`rounded-2xl bg-gradient-to-br ${color} p-6 text-white shadow-lg`}
    >
